...
def generate_thumbnail_prompt(video_summary, image_classifications, brand_theme=None):
    ...
    try:
        ...
        {image_info}
        3. **Brand Theme**: {brand_theme if brand_theme else 'Not specified'}
...
def process_inputs():
  ...
  "images": [
    ...
    prompt = generate_thumbnail_prompt(video_summary, image_classifications, brand_theme)
